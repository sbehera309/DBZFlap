...
public class GravityGoten {
    ...
    public GravityGoten(float x, float y){
        position = new Vector3(x, y, 0);
        velocity = new Vector3(0,0,0);
        text = new Texture("goten animation.png");
        //Causes goten to be slightly animated by splitting the picture into different frames of goten
        gotenAnimation = new animation(new TextureRegion(text), 3, 0.5f);
